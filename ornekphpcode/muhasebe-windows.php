...
$page_title = "Muhasebe - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="muhasebe-windows.php" class="module-btn active" data-module="accounting">
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="accounting">
                    <i class="fas fa-calculator"></i>
                    <span>Muhasebe</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('accounting')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">Muhasebe</h4>
                    <div class="content-actions">
                        ...
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshAccounting()">
    ...
    <script>
        function newTransaction() {
            window.location.href = 'muhasebe-islem-ekle.php';
        }
        
        function viewReports() {
            window.location.href = 'muhasebe-raporlar.php';
        }
        
        function refreshAccounting() {
            loadAccountingContent();
            showNotification('Muhasebe verileri yenilendi', 'success');
        }
        
        function loadAccountingContent() {
            $('#accounting-content').html(`
                <div class="text-center py-5">
                    <div class="spinner"></div>
                    <p class="mt-3 text-muted">Muhasebe verileri yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#accounting-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('Muhasebe verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
