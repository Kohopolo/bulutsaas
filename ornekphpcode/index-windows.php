...
$page_title = "Dashboard - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            <a href="index-windows.php" class="module-btn active" data-module="dashboard">
            ...
            <div class="content-panel">
                <div class="content-header">
                    ...
                    <div class="content-actions">
                        <button class="btn btn-primary btn-sm" onclick="addReservation()">
    ...
    <script>
        function addReservation() {
            window.location.href = 'rezervasyon-ekle.php';
        }
        ...
        function refreshDashboard() {
            ...
            showNotification('Dashboard verileri yenilendi', 'success');
        }
        ...
        function loadDashboardContent() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#dashboard-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('Dashboard verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
