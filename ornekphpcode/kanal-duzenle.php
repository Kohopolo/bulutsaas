...
requireDetailedPermission('kanal_duzenle', 'Kanal düzenleme yetkiniz bulunmamaktadır.');

$page_title = "Kanal Düzenle";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Kanal kodu benzersizlik kontrolü (kendisi hariç)
        $existing_kanal = fetchOne("SELECT id FROM kanallar WHERE kanal_kodu = ? AND id != ?", [$kanal_kodu, $kanal_id]);
        if ($existing_kanal) {
        ...
        $sql = "UPDATE kanallar SET 
            kanal_adi = ?, kanal_tipi = ?, kanal_kodu = ?, website = ?, api_endpoint = ?, 
            api_key = ?, api_secret = ?, komisyon_orani = ?, aktif = ?, otomatik_senkronizasyon = ?, 
            senkronizasyon_sikligi = ?, test_modu = ?, maksimum_gunluk_rezervasyon = ?, 
            minimum_rezervasyon_suresi = ?, maksimum_rezervasyon_suresi = ?, iptal_politikasi = ?, 
            odeme_politikasi = ?, ozel_notlar = ?, guncelleme_tarihi = NOW(), guncelleyen_kullanici_id = ?
            WHERE id = ?";
        ...
        $params = [
            ...
            $iptal_politikasi, $odeme_politikasi, $ozel_notlar, $_SESSION['user_id'], $kanal_id
        ];

        executeQuery($sql, $params);

        // Başarı mesajı
        $success_message = "Kanal başarıyla güncellendi.";

        // Güncellenmiş kanal bilgilerini tekrar getir
        $kanal = fetchOne("SELECT * FROM kanallar WHERE id = ?", [$kanal_id]);
...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <div class="quick-actions">
                        ...
                        <a href="kanal-performans.php?kanal_id=<?= $kanal['id'] ?>" class="quick-action-btn">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="info-item">
                        ...
                        <span class="info-value">#<?= $kanal['id'] ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Oluşturma Tarihi:</span>
                        <span class="info-value"><?= date('d.m.Y H:i', strtotime($kanal['olusturma_tarihi'])) ?></span>
                    </div>
                    <div class="info-item">
                        <span class="info-label">Son Güncelleme:</span>
                        <span class="info-value"><?= date('d.m.Y H:i', strtotime($kanal['guncelleme_tarihi'])) ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <span class="badge bg-<?= $kanal['aktif'] ? 'success' : 'danger' ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="kanal_adi" name="kanal_adi" 
                                   value="<?= htmlspecialchars($kanal['kanal_adi']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="kanal_kodu" name="kanal_kodu" 
                                   value="<?= htmlspecialchars($kanal['kanal_kodu']) ?>" 
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="kanal_tipi" name="kanal_tipi" required>
                                ...
                                <option value="ota" <?= $kanal['kanal_tipi'] === 'ota' ? 'selected' : '' ?>>OTA (Online Travel Agency)</option>
                                <option value="gds" <?= $kanal['kanal_tipi'] === 'gds' ? 'selected' : '' ?>>GDS (Global Distribution System)</option>
                                <option value="direct" <?= $kanal['kanal_tipi'] === 'direct' ? 'selected' : '' ?>>Direct (Doğrudan)</option>
                                <option value="corporate" <?= $kanal['kanal_tipi'] === 'corporate' ? 'selected' : '' ?>>Corporate (Kurumsal)</option>
                                <option value="social" <?= $kanal['kanal_tipi'] === 'social' ? 'selected' : '' ?>>Social Media</option>
                                <option value="other" <?= $kanal['kanal_tipi'] === 'other' ? 'selected' : '' ?>>Diğer</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control" id="website" name="website" 
                                   value="<?= htmlspecialchars($kanal['website']) ?>" 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="url" class="form-control" id="api_endpoint" name="api_endpoint" 
                                   value="<?= htmlspecialchars($kanal['api_endpoint']) ?>" 
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="api_key" name="api_key" 
                                   value="<?= htmlspecialchars($kanal['api_key']) ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control" id="api_secret" name="api_secret" 
                                   value="<?= htmlspecialchars($kanal['api_secret']) ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="komisyon_orani" name="komisyon_orani" 
                                   value="<?= htmlspecialchars($kanal['komisyon_orani']) ?>" 
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="senkronizasyon_sikligi" name="senkronizasyon_sikligi">
                                <option value="realtime" <?= $kanal['senkronizasyon_sikligi'] === 'realtime' ? 'selected' : '' ?>>Gerçek Zamanlı</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="maksimum_gunluk_rezervasyon" name="maksimum_gunluk_rezervasyon" 
                                   value="<?= htmlspecialchars($kanal['maksimum_gunluk_rezervasyon']) ?>" 
                                   min="1">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="minimum_rezervasyon_suresi" name="minimum_rezervasyon_suresi" 
                                   value="<?= htmlspecialchars($kanal['minimum_rezervasyon_suresi']) ?>" 
                                   min="1" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="maksimum_rezervasyon_suresi" name="maksimum_rezervasyon_suresi" 
                                   value="<?= htmlspecialchars($kanal['maksimum_rezervasyon_suresi']) ?>" 
                                   min="1" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="otomatik_senkronizasyon" name="otomatik_senkronizasyon" 
                                       <?= $kanal['otomatik_senkronizasyon'] ? 'checked' : '' ?>>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="iptal_politikasi" name="iptal_politikasi" rows="4" 
                                      placeholder="İptal politikası detayları..."><?= htmlspecialchars($kanal['iptal_politikasi']) ?></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="odeme_politikasi" name="odeme_politikasi" rows="4" 
                                      placeholder="Ödeme politikası detayları..."><?= htmlspecialchars($kanal['odeme_politikasi']) ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="ozel_notlar" name="ozel_notlar" rows="3" 
                                      placeholder="Kanal hakkında özel notlar..."><?= htmlspecialchars($kanal['ozel_notlar']) ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-3 justify-content-between">
                            ...
                            <div class="d-flex gap-3">
                                <button type="button" class="btn btn-danger" onclick="deleteKanal()">
                                    <i class="fas fa-trash"></i> Kanalı Sil
                                </button>
    ...
    <script>
        ...
        // Sayfa yüklendiğinde mevcut kanal tipi açıklamasını göster
        document.addEventListener('DOMContentLoaded', function() {
            const kanalTipi = document.getElementById('kanal_tipi').value;
            if (kanalTipi && kanalTipiAciklamalari[kanalTipi]) {
                const infoDiv = document.getElementById('kanal-tipi-info');
                const descP = document.getElementById('kanal-tipi-desc');
                descP.textContent = kanalTipiAciklamalari[kanalTipi];
                infoDiv.style.display = 'block';
            }
        });
        ...
        function deleteKanal() {
            if (confirm('Bu kanalı silmek istediğinizden emin misiniz?\n\nBu işlem geri alınamaz ve kanal ile ilgili tüm veriler silinecektir.')) {
                // Kanal silme işlemi için ayrı bir sayfa oluşturulabilir
                window.location.href = 'kanal-sil.php?id=<?= $kanal['id'] ?>';
            }
        }
    </script>
</body>
