"""
Satış Yönetimi Modülü Permission'ları Oluşturma Command
...
class Command(BaseCommand):
    help = 'Satış Yönetimi modülü permission\'larını oluşturur'
            ...
            with schema_context(schema_name):
                ...
                with schema_context(get_public_schema_name()):
                    try:
                        ...
                        self.stdout.write(
                            self.style.WARNING(f'  [SKIP] Sales modülü bulunamadı')
                        )
                        return
                ...
                for perm_code, perm_name in permissions_data.items():
                    permission, created = Permission.objects.get_or_create(
                        ...
                        defaults={
                            'name': perm_name,
                            'description': f'Satış Yönetimi - {perm_name}',
