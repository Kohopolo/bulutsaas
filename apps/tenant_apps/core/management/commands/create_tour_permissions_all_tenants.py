"""
Tüm tenant schema'larında tur modülü yetkilerini oluştur
"""
...
class Command(BaseCommand):
    help = 'Tüm tenant schema\'larında tur modülü yetkilerini oluştur'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'\n{total_tenants} tenant schema\'da tur yetkileri oluşturulacak...\n')
        ...
        for tenant in tenants:
            try:
                ...
                with schema_context(tenant.schema_name):
                    call_command('create_tour_permissions', verbosity=0)
        ...
        # Özet
        self.stdout.write('\n' + '='*50)
        self.stdout.write(self.style.SUCCESS(f'Toplam: {total_tenants} tenant'))
