...
$page_title = "Ayarlar - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="ayarlar-windows.php" class="module-btn active" data-module="settings">
                <i class="fas fa-cog"></i>
                <span>⚙️ Ayarlar</span>
            </a>
        </nav>
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="settings">
                    <i class="fas fa-cog"></i>
                    <span>Ayarlar</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('settings')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">Ayarlar</h4>
                    <div class="content-actions">
                        ...
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshSettings()">
    ...
    <script>
        ...
        function refreshSettings() {
            loadSettingsContent();
            showNotification('Ayarlar yenilendi', 'success');
        }
        ...
        function loadSettingsContent() {
            $('#settings-content').html(`
                <div class="text-center py-5">
                    ...
                    <p class="mt-3 text-muted">Ayarlar yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#settings-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('Ayarlar yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
