...
$page_title = "İnsan Kaynakları - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="ik-windows.php" class="module-btn active" data-module="hr">
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="hr">
                    <i class="fas fa-user-tie"></i>
                    <span>İnsan Kaynakları</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('hr')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">İnsan Kaynakları</h4>
                    <div class="content-actions">
                        <button class="btn btn-primary btn-sm" onclick="addEmployee()">
                            <i class="fas fa-plus"></i> Personel Ekle
                        </button>
                        <button class="btn btn-outline-secondary btn-sm" onclick="viewSchedule()">
                            <i class="fas fa-calendar"></i> Vardiya
                        </button>
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshHr()">
    ...
    <script>
        function addEmployee() {
            window.location.href = 'ik-personel-ekle.php';
        }
        
        function viewSchedule() {
            window.location.href = 'ik-vardiya.php';
        }
        
        function refreshHr() {
            loadHrContent();
            showNotification('İK verileri yenilendi', 'success');
        }
        
        function loadHrContent() {
            $('#hr-content').html(`
                <div class="text-center py-5">
                    <div class="spinner"></div>
                    <p class="mt-3 text-muted">İK verileri yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#hr-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('İK verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
