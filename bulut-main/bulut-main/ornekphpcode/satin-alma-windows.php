...
$page_title = "Satın Alma - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="satin-alma-windows.php" class="module-btn active" data-module="procurement">
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="procurement">
                    <i class="fas fa-shopping-cart"></i>
                    <span>Satın Alma</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('procurement')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">Satın Alma</h4>
                    <div class="content-actions">
                        <button class="btn btn-primary btn-sm" onclick="newPurchase()">
                            <i class="fas fa-plus"></i> Yeni Satın Alma
                        </button>
                        <button class="btn btn-outline-secondary btn-sm" onclick="viewSuppliers()">
                            <i class="fas fa-truck"></i> Tedarikçiler
                        </button>
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshProcurement()">
    ...
    <script>
        function newPurchase() {
            window.location.href = 'satin-alma-yeni.php';
        }
        
        function viewSuppliers() {
            window.location.href = 'satin-alma-tedarikci.php';
        }
        
        function refreshProcurement() {
            loadProcurementContent();
            showNotification('Satın alma verileri yenilendi', 'success');
        }
        
        function loadProcurementContent() {
            $('#procurement-content').html(`
                <div class="text-center py-5">
                    <div class="spinner"></div>
                    <p class="mt-3 text-muted">Satın alma verileri yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#procurement-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('Satın alma verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
