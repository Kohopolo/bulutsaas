...
$page_title = "Teknik Servis - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="teknik-windows.php" class="module-btn active" data-module="technical">
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="technical">
                    <i class="fas fa-tools"></i>
                    <span>Teknik Servis</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('technical')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">Teknik Servis</h4>
                    <div class="content-actions">
                        <button class="btn btn-primary btn-sm" onclick="newRequest()">
                            <i class="fas fa-plus"></i> Yeni Talep
                        </button>
                        <button class="btn btn-outline-secondary btn-sm" onclick="viewEquipment()">
                            <i class="fas fa-cogs"></i> Ekipmanlar
                        </button>
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshTechnical()">
                            <i class="fas fa-sync-alt"></i> Yenile
                        </button>
                    </div>
                </div>
                <div class="content-body" id="content-body">
                    <!-- Teknik Servis İçeriği -->
    ...
    <!-- Teknik Servis JavaScript -->
    <script>
        function newRequest() {
            window.location.href = 'teknik-talep-ekle.php';
        }
        
        function viewEquipment() {
            window.location.href = 'teknik-ekipmanlar.php';
        }
        
        function refreshTechnical() {
            loadTechnicalContent();
            showNotification('Teknik servis verileri yenilendi', 'success');
        }
        
        function loadTechnicalContent() {
            $('#technical-content').html(`
                <div class="text-center py-5">
                    <div class="spinner"></div>
                    <p class="mt-3 text-muted">Teknik servis verileri yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#technical-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('Teknik servis verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
