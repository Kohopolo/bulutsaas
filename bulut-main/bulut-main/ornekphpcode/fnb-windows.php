...
$page_title = "F&B - Otel Yönetim Sistemi";
?>
...
<body>
    <div class="windows-container">
        ...
        <nav class="modules-menu">
            ...
            <a href="fnb-windows.php" class="module-btn active" data-module="fnb">
        ...
        <div class="main-content-area">
            ...
            <div class="tabs-container">
                <div class="tab active" data-tab="fnb">
                    <i class="fas fa-utensils"></i>
                    <span>F&B</span>
                    <i class="fas fa-times tab-close" onclick="closeTab('fnb')"></i>
                </div>
            ...
            <div class="content-panel">
                <div class="content-header">
                    <h4 id="content-title">F&B</h4>
                    <div class="content-actions">
                        <button class="btn btn-primary btn-sm" onclick="newOrder()">
                            <i class="fas fa-plus"></i> Yeni Sipariş
                        </button>
                        <button class="btn btn-outline-secondary btn-sm" onclick="viewMenu()">
                            <i class="fas fa-list"></i> Menü
                        </button>
                        <button class="btn btn-outline-primary btn-sm" onclick="refreshFnb()">
    ...
    <script>
        function newOrder() {
            window.location.href = 'fnb-siparis-al.php';
        }
        
        function viewMenu() {
            window.location.href = 'fnb-menu.php';
        }
        
        function refreshFnb() {
            loadFnbContent();
            showNotification('F&B verileri yenilendi', 'success');
        }
        
        function loadFnbContent() {
            $('#fnb-content').html(`
                <div class="text-center py-5">
                    <div class="spinner"></div>
                    <p class="mt-3 text-muted">F&B verileri yükleniyor...</p>
                </div>
            `);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#fnb-content').html(response.content).addClass('fade-in');
                    } else {
                        showError('F&B verileri yüklenemedi: ' + response.message);
                    }
                },
                error: function() {
