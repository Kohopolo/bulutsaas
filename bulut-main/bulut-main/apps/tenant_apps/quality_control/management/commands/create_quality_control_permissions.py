"""
Kalite Kontrol Modülü Permission'ları Oluşturma Command
...
class Command(BaseCommand):
    help = 'Kalite Kontrol modülü permission\'larını oluşturur'
            ...
            with schema_context(schema_name):
                ...
                with schema_context(get_public_schema_name()):
                    try:
                        ...
                        self.stdout.write(
                            self.style.WARNING(f'  [SKIP] Quality Control modülü bulunamadı')
                        )
                        return
                ...
                for perm_code, perm_name in permissions_data.items():
                    permission, created = Permission.objects.get_or_create(
                        ...
                        defaults={
                            'name': perm_name,
                            'description': f'Kalite Kontrol - {perm_name}',
